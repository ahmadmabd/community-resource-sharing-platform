...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen bg-[#0F4C35] flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="px-8 py-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              ...
              <a
                href="#"
                className="text-xs text-[#0F4C35] hover:underline mt-1.5 inline-block"
              >
                Forgot password?
              </a>
            </div>
          ...
          <div className="flex justify-center gap-10">
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-9 h-9 bg-[#0F4C35]/5 rounded-xl flex items-center justify-center">
                <Camera size={16} color="#0F4C35" />
              </div>
              <p className="text-xs text-gray-400">Borrow</p>
            </div>
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-9 h-9 bg-[#0F4C35]/5 rounded-xl flex items-center justify-center">
                <Users size={16} color="#0F4C35" />
              </div>
              <p className="text-xs text-gray-400">Connect</p>
            </div>
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-9 h-9 bg-[#0F4C35]/5 rounded-xl flex items-center justify-center">
                <Star size={16} color="#0F4C35" />
              </div>

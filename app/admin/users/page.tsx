...
export default function AdminUsersPage() {
  ...
  async function handleSuspend() {
    ...
    try {
      ...
      toast.success(
        `${suspendModal.name} has been suspended`,
        successToastStyle,
      );
                  ...
                  <td className="px-5 py-4 text-right">
                    <div className="relative inline-block">
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors hover:cursor-pointer"
                      >
                      ...
                      {openMenu === user.id && (
                        <div className="absolute right-0 top-8 z-10 bg-white border border-gray-200 rounded-xl shadow-lg py-1 w-40">
                          {user.status === "ACTIVE" ? (
                            ...
                            <button
                              onClick={() =>
                                handleUnsuspend(user.id, user.name)
                              }
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md mx-4">
            ...
            <p className="text-sm text-gray-500 mb-4">
              This user will be immediately logged out and shown this reason
